...
**Conclusion:** this is a genuine driver/emulation limitation, not a missing step. Windows gets the same treatment as Metasploitable2 — its own dedicated, untagged zone. See [ADR-008](../adr/008-legacy-and-windows-zones-for-non-taggable-hosts.md).
