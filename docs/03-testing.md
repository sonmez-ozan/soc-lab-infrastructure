...
Connectivity, isolation, and persistence tests run against this lab, with results. Tests build on each other — later ones assume earlier ones passed.
...
This asymmetry is the evidence the isolation policy is enforced, not just documented.
